...
@method_decorator(plp_login_required, name='dispatch')
...
def add_news_category(request):
    ...
    if not exists:
        ...
        return restful.params_error(message='This category is already Exist!')
...
def edit_news_category(request):
    ...
    if form.is_valid():
        ...
        try:
            ...
            return restful.params_error(message='This category does not Exist! ')
    else:
...
def delete_news_category(request):
    ...
    try:
        ...
        return restful.unauth(message='This category does not Exist! ')
